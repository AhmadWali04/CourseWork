...
*/
isLetter:
//we fix the isLetter by adding an end to check against (_isLetter)
//and by using a stack to save to and call our values in our nested subroutines
//so that we dont lose information
    ...
    mov     r0, #0           
//checks ithe chaaracter is lower (if r0=1) and then checks if its uppercase.
