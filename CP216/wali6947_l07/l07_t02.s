...
//we use a stack to save the values, compare against A and Z to see if its a capital letter
//then compare with a and z to check for lowercase. Same concept as last task
isLetter:
    stmfd   sp!, {lr}        
    ...
    cmp     r2, #'z'        
    ble     _isLetterTrue    
	//in the event it is or isnt a letter we store that information
	//with a nested stack and branch up again
_notLetter:
    mov     r0, #0          
    ldmfd   sp!, {lr}        
    bx      lr              
